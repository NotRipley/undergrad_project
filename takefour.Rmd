...
simple_data <- function(m, n, N, k, overlap, equalin) {
  ...
  if (equalin == FALSE) {
    p_var <- matrix(rnorm(k, p_var[[1]], 0.25),  nrow = 1, ncol = k) # might need slight adjusting
  }
...
sample_maker_noisy <- function(n, m, x, N) {
  # n - useful features
...
test <- simple_data(500, 5, 0, 5, TRUE, FALSE)
