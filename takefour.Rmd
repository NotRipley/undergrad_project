...
Pair plots - prcomp in R after manual PCA or with splatter/ scater - the plotReducedDim from scater does it really well
choosing number of principal components - justify decision process - we now want to get an elbow plot for variance explained by the 
