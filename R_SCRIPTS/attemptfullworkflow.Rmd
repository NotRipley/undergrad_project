...
And then we want to get our functions for cluster quality assessment. We want calinkski-harabasz, davies-bouldin, silhouette, and then modularity seems a decent one since it's the reward function for Louvain? We can see what Leiden's reward function is and maybe include that.


I think that a good move soon will be to update these functions to take the whole seurat object maybe. We want to make our life on the actual coding end easy and have the complexity be hidden in the functions. 
