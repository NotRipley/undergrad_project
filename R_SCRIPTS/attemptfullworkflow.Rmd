...
for (i in 1:50) {
  ...
  # calculate gap stat of the clustering
  gap <- clusGap()
...
seurat_to_dbscan <- function() {
  # takes seurat and estimates eps and minpts based on the data. clusters by dbscan and returns list of clustering and dbscan full object. 
